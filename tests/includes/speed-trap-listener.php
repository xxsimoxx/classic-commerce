...
class SpeedTrapListener implements PHPUnit_Framework_TestListener {
	 ...
	 */
	public function addWarning( PHPUnit\Framework\Test $test, PHPUnit_Framework_Warning $e, $time ): void {
	}
	 ...
	 * @param float                                   $time
	 */
	public function addFailure( PHPUnit\Framework\Test $test, PHPUnit_Framework_AssertionFailedError $e, $time ): void {
	}
